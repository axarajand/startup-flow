...
<?php require '../template-sidebar.php'; ?>
    ...
    <div class="container py-6">
        ...
        <div class="flex items-center md:justify-between flex-wrap gap-2 mb-6">
            <h4 class="text-default-900 text-lg font-medium mb-2">Request Approval</h4>
        </div>
        <!-- Page Title End -->
        ...
        <div class="grid lg:grid-cols-1 grid-cols-1 gap-6">
            <div class="card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">List Request Approval</h4>
                </div>
                <div>
                        ...
                        <div class="min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <?php
                                        renderTableRows($HTaskRequest, function($htr) {
                                    ?>
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <button class="text-primary hover:text-sky-700"
                                                    ...
                                                    data-task-record="<?= $htr['task_record']; ?>"
                                                    >Detail</button>
                                            </td>
                                        </tr>
                                    <?php
    ...
    <div class="container py-6">
        ...
        <div class="grid lg:grid-cols-1 grid-cols-1 gap-6">
            <div class="card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">Accepted History</h4>
                </div>
                <div>
                    <div class="overflow-x-auto">
                        <div class="min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                    <?php
                                        renderTableRows($HTaskDone, function($htr) {
                                    ?>
                                        <tr class="hover:bg-gray-100">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-default-800">
                                                <?= htmlspecialchars($htr['user_name']); ?></td>
    ...
    <div class="container py-6">
        ...
        <div class="grid lg:grid-cols-1 grid-cols-1 gap-6">
            <div class="card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">Revisioned History</h4>
                </div>
                <div>
                    <div class="overflow-x-auto">
                        <div class="min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                    <?php
                                        renderTableRows($HTaskRevision, function($htr) {
                                    ?>
                                        <tr class="hover:bg-gray-100">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-default-800">
                                                <?= htmlspecialchars($htr['user_name']); ?></td>
            ...
            <div class="-translate-y-5 hs-overlay-open:translate-y-0 hs-overlay-open:opacity-100 opacity-0 ease-in-out transition-all duration-500 sm:max-w-2xl sm:w-full my-8 sm:mx-auto flex flex-col bg-white shadow-sm rounded"> 
                    <div
                        ...
                        <div
                            ...
                            <a class="py-2 px-5 inline-flex items-center justify-center font-medium tracking-wide align-middle duration-500 text-sm text-center btn bg-warning hover:bg-primary-700 hover:border-primary-700 text-white rounded-md"
...
<script>
    document.querySelectorAll('button[data-hs-overlay="#modal-lg"]').forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            const deadlineStart = this.getAttribute('data-deadline-start');
            const deadlineEnd = this.getAttribute('data-deadline-end');
            const taskRecord = this.getAttribute('data-task-record');
            ...
            if (file) {
                ...
                attachmentHtml = `<tr><td colspan="3">No attachment available</td></tr>`;
            }

            attachmentTable.innerHTML = attachmentHtml;

            // Handle tombol approve / revision
            const approveLink = document.getElementById('approveTaskLink');
            const revisionLink = document.getElementById('revisionTaskLink');

            if (taskRecord === 'request') {
                approveLink.style.display = '';
                revisionLink.style.display = '';
                approveLink.href = `../crud/update_task_req.php?task_id=${taskId}&task_record=done`;
                revisionLink.href = `../crud/update_task_req.php?task_id=${taskId}&task_record=revision`;
            } else {
